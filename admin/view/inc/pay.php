...
<body>
    <form action="http://localhost/DO_AN_PHP_MYSQL_2023/admin/uploads/xulyadd_cthd.php" method="POST">
        <div id="cart">
            <div class="row">
                <div class="col-md-6 form">
                    <?php
                    if (isset($_SESSION['username'], $_SESSION['user_id'], $_SESSION['DiaChi'], $_SESSION['SoDienThoai'], $_SESSION['Email'])) {
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="<?php echo $dia_chi; ?>" class="form-control" id="DiaChi"
                                name="DiaChi">
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="cart">
                                ...
                                <input class="card-text" type="text" id="cart-total-input" name="cart_total_input"
                                    readonly>
                                <span id="cart-total-text">VNĐ</span>
                            </div>
                            <input type="submit" name="add_to_database" class="btn btn-success" value="Thanh toán" />
                        </div>
                    </div>
                </div>
            </div>
