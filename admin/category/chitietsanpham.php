                    ...
                    <div class="col-sm-6 ttsp " style="padding-left:30px">
                        ...
                        <div class="row text-start submit1">
                            <div class="col-md-9" style="text-color:white;">
                                ...
                                <button class="btn-danger" data-bs-toggle="offcanvas" href="#offcanvasExample1" role="button"
                                    aria-controls="offcanvasExample" style="text-color:white;"> Mua ngay</button>
