                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row text-start ">
                                                            ...
                                                            <p class="fs-4" style="color: red;">
                                                                <?php echo $productPrice ?><sup>₫</sup> <span
                                                                    class="text-muted " style="font-size: 15px">| Đã bán:
                                                                    125 sản phẩm</span>
                                                            </p>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="row text-start ">
                                                                    ...
                                                                    <p class="fs-4" style="color: red;">
                                                                        <?php echo $productPrice ?><sup>₫</sup> <span
                                                                            class="text-muted " style="font-size: 15px">| Đã
                                                                            bán:
                                                                            125 sản phẩm</span>
                                                                    </p>
                                                                </div>
