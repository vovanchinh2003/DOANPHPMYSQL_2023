    ...
    <header>
                        ...
                        <div class="offcanvas-body">
                            <div class="row">
                                <div class="logo" style="padding-bottom:20px">
                                    <a href=""><img style="width: 370px; height: 170px" src="images/logo.png"></a>
                                </div>
                            </div>
                            <!----login --->
        ...
        <div class="row">
            <div class="col-2 logo_1">
                <a href="http://localhost/DOANPHPMYSQL_2023/admin/category/home.php"><img src="images/logo.png"
                        width="300px"></a>
            </div>
            <div class="col-8">
                <nav class="navbar">
